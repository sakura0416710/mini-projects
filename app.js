document.addEventListener("DOMContentLoaded", () => {
  ...
  //2-1. 리스트 객체 관리
  const itemImageMap = {
  "오늘의 커리어우먼은 바로 나": "./image/the_row2.png",
  "깔끔 러블리걸": "./image/the_row3.png",
  "올화이트룩": "./image/the_row.png",
  "말해뭐해 가을의 르메르": "./image/remaire.png",
  "디테일의 신": "./image/remaire2.png",
  "도쿄 멋쟁이": "./image/nanamica.png",
  "쟤니?죄니": "./image/chanel.png",
  "트위드로 종결": "./image/chanel2.png",
  "추위도 멋은 포기모태": "./image/vvw.png",
  "러블리의 인간화": "./image/shushu.png",
  "이 구역 깜찍큩걸": "./image/miumiu.png",
  "러블리 으른ver": "./image/shushu2.png",
  "꾸안꾸 미우미우걸": "./image/miumiu2.png",
  "성수동 점령가능룩": "./image/bm.png",
  "퇴근하고 한남동으로 모여": "./image/balenciaga.png",
  "미우미우인간의 가을룩": "./image/miumiu3.png",
  "인스타 여신은 바로 나": "./image/bm2.png",
  "고어텍스 한 스푼": "./image/act2.png",
  "편하고 멋지고 다해버려": "./image/act1.png",
  "당신의 고급미에 치얼스": "./image/ysl.png",
  "Back to 90's": "./image/jil_sander.png",
  "차분한 블랙 & 화이트": "./image/prada.png",
  "용기가 필요한 Girl": "./image/prada2.png"
};
