document.addEventListener("DOMContentLoaded", () => {
  ...
  //2-1. 리스트 객체 관리
  const itemImageMap = {
  "오늘의 커리어우먼은 바로 나": "../룰렛아이템/더로우2.png",
  "깔끔 러블리걸": "../룰렛아이템/더로우3.png",
  "올화이트룩": "../룰렛아이템/더로우.png",
  "말해뭐해 가을의 르메르": "../룰렛아이템/르메르.png",
  "디테일의 신": "../룰렛아이템/르메르2.png",
  "도쿄 멋쟁이": "../룰렛아이템/나나미카.png",
  "쟤니?죄니": "../룰렛아이템/샤넬.png",
  "트위드로 종결": "../룰렛아이템/샤넬2.png",
  "추위도 멋은 포기모태": "../룰렛아이템/비비안웨스트우드.png",
  "러블리의 인간화": "../룰렛아이템/슈슈통.png",
  "이 구역 깜찍큩걸": "../룰렛아이템/미우미우.png",
  "러블리 으른ver": "../룰렛아이템/슈슈통2.png",
  "꾸안꾸 미우미우걸": "../룰렛아이템/미우미우2.png",
  "성수동 점령가능룩": "../룰렛아이템/브랜디멜빌.png",
  "퇴근하고 한남동으로 모여": "../룰렛아이템/발렌시아가.png",
  "인스타 여신은 바로 나": "../룰렛아이템/브랜디멜빌2.png",
  "고어텍스 한 스푼": "../룰렛아이템/아크테릭스2.png",
  "편하고 멋지고 다해버려": "../룰렛아이템/아크테릭스1.png",
  "당신의 고급미에 치얼스": "../룰렛아이템/입생로랑.png",
  "Back to 90's": "../룰렛아이템/질샌더.png",
  "차분한 블랙 & 화이트": "../룰렛아이템/프라다.png",
  "용기가 필요한 Girl": "../룰렛아이템/프라다2.png"
};
  ...
  function showResult(finalItem) {
    ...
    // 매핑 객체에서 이미지 경로 가져오기
    const imgPath = itemImageMap[itemName] || "../룰렛아이템/default.png"; 
